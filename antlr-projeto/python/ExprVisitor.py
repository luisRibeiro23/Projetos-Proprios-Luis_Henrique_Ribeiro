...
class ExprVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by ExprParser#AbsExpr.
    def visitAbsExpr(self, ctx:ExprParser.AbsExprContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ExprParser#FactExpr.
    def visitFactExpr(self, ctx:ExprParser.FactExprContext):
        return self.visitChildren(ctx)
